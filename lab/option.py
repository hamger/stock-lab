...
_default = dict(
    ...
    store_path = 'USER_HOME/tmp/lab_export',
    thread = 10,
...
parser.add_argument('--strategy', type=str, default=_default['strategy'], dest='strategy', help='Target strategy for back testing, Default: %s' % _default['strategy'])
